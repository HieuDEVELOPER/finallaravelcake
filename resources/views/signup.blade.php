    ...
    <div class="container">
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="date" name="date" id="date" class="form-control" value="<?php if (isset($_POST['date'])) {
                    echo $_POST['date'];
                } ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="web" id="web" class="form-control" placeholder="Enter web ..."
                    value="<?php if (isset($_POST['web'])) {
                        echo $_POST['web'];
                    } ?>">
            </div>
            <div class="form-group">
